...
{
    int count = 0;
    // spawn snelheid is sneller als het spawnSpeed omlaag gaat
    int spawnSpeed = 30;
    int randomSpawn;
    ...
    //Achtergrond en Player
    public MyWorld()
    {    
        // Create a new world with 600x400 cells with a cell size of 1x1 pixels.
        super(1000, 800, 1); 
        mainPlayer = new Player(weaponButton, powerUp);
    ...
    public void act()
    {
        ...
        while(Greenfoot.isKeyDown("escape")){
        Greenfoot.delay(1);
        }
        spawnZombies();
